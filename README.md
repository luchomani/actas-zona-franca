...
Aplicación web interna para extraer automáticamente 16 campos estandarizados
...
extraer_texto_pdf()          → PyMuPDF (fitz) obtiene el texto plano
        │
        ▼
extraer_campos_acta()        → RegEx sobre el texto → dict de 16 campos + QA
        │
        ▼
...
| 3 | Tránsito (DTA) | "Número ... se procede" |
| 4 | N°FMM | Tabla MERCANCÍA |
| 5 | N°FECHA | "FECHA GENERACIÓN DEL ACTA" |
| 6 | Ingreso último vehículo | Fila de desprecintaje |
| 7 | Fecha autorización tránsito | "(YYYY/MM/DD)" |
| 8 | Fecha máxima finalización | "(YYYY/MM/DD)" |
| 9 | Acta PICIZ | "Acta N." |
| 10 | Fecha acta inventario | = N°FECHA |
| 11 | No. Planilla recepción | No existe en este formato → "N/A" |
| 12 | Peso báscula ZFC | "TOTALES:" |
| 13-14 | Bitácora / Rad. solicitud | Vacíos, diligenciamiento manual |
| 15 | Observaciones/Inconsistencias | Bloque "Observaciones" |
| 16 | SINO | "Inconsistencias: N/A" → NO, cualquier otro valor → SI |
